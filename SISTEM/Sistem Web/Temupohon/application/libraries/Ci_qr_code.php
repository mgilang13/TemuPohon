...
class Ci_qr_code
{
	...
	private $_cachedir 			= 'assets/tmp/cache/';
	private $_error_log_dir 	= 'assets/tmp/logs/';
	...
	public function generate($params = array())
	{
		...
		if(isset($params['savepohon']))
		{
			QRcode::png($params['data'], $params['savepohon'], $level, $size, 2);
			return $params['savepohon'];
		}
		else
		{
