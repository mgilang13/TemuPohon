 ...
 <body>   
   ...
   <div id="content">      
   <h3>Hello <span><b><?php echo $nama; ?></b></span>, Silakan isi password baru anda.</h3>   
   <?php echo form_open('LupaPasswordAdmin/reset_password/token/'.$token); ?>  
   ...
   <p> <?php echo form_error('passconf'); ?> </p>  <br> 
   <p>   
