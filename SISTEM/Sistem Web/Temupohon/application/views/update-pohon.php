...
<header>
		...
		<h1 class="title-page">Update Data Pohon</h1>
...
<?php
	...
	echo "<input type='hidden' name='id_pohon' value='".$row['id_pohon']."'>";
	...
	echo "<td><h3>Preview Gambar</h3></td> <td><img src='".base_url()."/assets/images/uploads/gambarPohon/".$row['nama_gambar']."' width='160px' height='100px'><br><br>";
